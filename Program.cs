...
namespace Skola.NET
{
    internal class Program
    {
        ...
        static void Main()
        {
            using (var context = new SkolaContext())
            {
                ...
                while (continueProgram)// Loop för Menyn
                {
                    ...
                    Console.WriteLine("6. Alla aktiva kurser");
                    Console.WriteLine("7. Lägg till student");
        ...
        static void FetchPersonal(SkolaContext context) // Alla alternativ för att hämta personal
        {
            ...
            Console.WriteLine("4. Personal per avdelning");
            ...
            switch (categoryChoice)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    Console.Write("Ange avdelning: ");
                    string avdelning = Console.ReadLine();
                    personalQuery = context.Personals.Where(p => p.Avdelning == avdelning);
                    break;
                default:
            ...
            if (personalList.Any())
            {
                ...
                {
                    Console.WriteLine($"ID: {personal.PersonalId}, Name: {personal.Namn}, Position: {personal.Befattning}, Avdelning: {personal.Avdelning}");
                }
            }
            else
            {
        ...
        static void FetchAllStudents(SkolaContext context) // Alla alternativ för att hämta elever
        {
            ...
            Console.WriteLine("5. Information om alla elever");
            ...
            switch (sortingChoice)
            {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    studentsQuery = context.Students;
                    break;
                default:
                    Console.WriteLine("Ogiltigt val. Skickas tillbaka till menyn.");
                    return;
            ...
            studentsQuery = context.Students.Include(s => s.Fkklass);
            ...
            if (studentsList.Any())
            {
                ...
                {
                    Console.WriteLine($"ID: {student.StudentId}, Name: {student.Namn}, Klass: {student.Fkklass?.Klassnamn}");
                }
            }
            else
            {
        ...
        static void DisplayActiveCourses(SkolaContext context)
        {
            var activeCourses = context.Kurs
                .Where(course => course.Aktiv == true)
                .ToList();
            ...
            if (activeCourses.Any())
            {
                ...
                {
                    Console.WriteLine($"ID: {course.KursId}, Kursnamn: {course.Kursnamn}");
                }
            }
            else
            {
                Console.WriteLine("Inga aktiva kurser hittade.");
            }
        }
    }
}